...
# function prints all the functions that are found into the file "chapter2-algorithm1-all_functions-modified-output.txt"
...
def Print_Founded_Functions_Into_File(source,dimension):
	with open('chapter2-algorithm1-all_functions-modified-output.txt','w') as output_file:
	...
	for i in range(len(source)):
		with open('chapter2-algorithm1-all_functions-modified-output.txt','a') as output_file:
...
print()
print('Found functions are listed in the txt file (chapter2-algorithm1-all_functions-modified-output.txt).')
